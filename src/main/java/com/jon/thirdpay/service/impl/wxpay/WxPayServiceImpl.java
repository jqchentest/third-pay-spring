...
import com.jon.thirdpay.model.wxpay.request.WxOrderQueryRequest;
import com.jon.thirdpay.model.wxpay.request.WxPayRefundRequest;
import com.jon.thirdpay.model.wxpay.request.WxPayUnifiedorderRequest;
import com.jon.thirdpay.model.wxpay.response.*;
...
import com.jon.thirdpay.utils.XmlUtil;
...
public class WxPayServiceImpl implements ThirdPayService {
    ...
    @Override
    public ResponseData<WxCreateOrderResponse> pay(ThirdPayRequest request) {
        try {
